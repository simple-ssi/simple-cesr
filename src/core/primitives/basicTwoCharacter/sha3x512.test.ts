...
import { makeSha3x512 } from './sha3x512.ts'
...
describe('makeSha3x512 enforces validity', () => {
  ...
  // example value
    ...
    expect(() => makeSha3x512('0'.padEnd(129, '0'))).toThrow(PrimitiveWrongLength)
    expect(() => makeSha3x512('0'.padEnd(127, '0'))).toThrow(PrimitiveWrongLength)
  })
})
