...
describe('Text Encoder', () => {
  ...
  it('gets "NAAAAAAAAAAB" from ["N", 1]', () => {
    const result = encodeAsText('N', Buffer.from([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01]))
    expect(result).toBe('NAAAAAAAAAAB')
  })
  it('gets "0FDdrzWhk2F6..." from ["0F", "ddaf35a19..."]', () => {
    const result = encodeAsText('0F', Buffer.from('ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f', 'hex'))
