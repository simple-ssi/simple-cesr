...
describe('Raw encoder (basic test covering a cross-section of code types)', () => {
  it("can encode a one-character primitive 'A'", () => {
  ...
  it("can encode a two-character primitive '0F'", () => {
  ...
  it("can encode a four-character primitive '1AAB'", () => {
