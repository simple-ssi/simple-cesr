...
import rawToText from './application/transformRawToText'
import { Raw } from './core/domains/raw'
import textToBinary from './application/transformTextToBinary'
import binaryToRaw from './application/transformBinaryToRaw'
import rawToBinary from './application/transformRawToBinary'
import binaryToText from './application/transformBinaryToText'
import textToRaw from './application/transformTextToRaw'
