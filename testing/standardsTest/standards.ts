// Fodder for a general standards test based on what is generated by the Matter class
// https://github.com/webOfTrust/signify-ts/

// code: the CESR type code
// length: the length of the encoded primitive, including code (from spec code tables)
// samples: specific examples from Matter where:
//  raw: is the input primitive value as a hexstring (will be converted to byte array in test) and
//  text: is the expected encoded value, as generated by Matter
